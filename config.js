  ...
  if (bad) {
    document.addEventListener('DOMContentLoaded', function () {
      document.body.innerHTML =
        ...
        '<p>Open <b>config.js</b> and replace the placeholder values with your real Supabase Project URL and anon key (from Supabase → Settings → API).</p>' +
        '<p><b>Correct URL format:</b><br><code>https://YOUR-PROJECT.supabase.co</code> (no trailing path)</p>' +
        '</div>';
    });
